...
def allJointControl_1(move_groups):
    #Right Leg
    ...
    #Left Arm
    setJointValue(move_groups[1], [0.60, 1.50])
    #Right Arm
    setJointValue(move_groups[4], [0.60, 1.50])
    planning_groups = [move_groups[0], 
                        move_groups[1], move_groups[4]]
...
def allJointControl_2(move_groups):
    #Right Leg
    setJointValue(move_groups[5], [0.60, -0.49])
    setJointValue(move_groups[6], [0.25])
    #Left Leg
    setJointValue(move_groups[2], [-0.30, 0])
    setJointValue(move_groups[3], [0.25])
    #Body
    setJointValue(move_groups[0], [-0.20, 0])
    #Left Arm
    setJointValue(move_groups[1], [0.50, 1.50])
    #Right Arm
    setJointValue(move_groups[4], [-0.50, 0])
    planning_groups = [move_groups[0], 
                        move_groups[4],
                        move_groups[1]
                        ]
...
def allJointControl_3(move_groups):
    ...
    setJointValue(move_groups[0], [-0.20, 0])
    #Left Arm
    setJointValue(move_groups[1], [-0.70, 0.70])
    #Right Arm
    setJointValue(move_groups[4], [-0.70, 0.70])
    planning_groups = [move_groups[0],
                        move_groups[1], move_groups[4]
                        ]
    for move_gr in planning_groups:
...
def allJointControl_5(move_groups):
    #Left Leg
    setJointValue(move_groups[2], [0.50, -0.49])
    setJointValue(move_groups[3], [0.25])
    #Right Leg
    setJointValue(move_groups[5], [-0.25, 0])
    setJointValue(move_groups[6], [-0.25])
    #Body
    setJointValue(move_groups[0], [-0.20, 0])
#    setJointValue(move_groups[0], [-0.00, 0])
    #Left Arm
#    setJointValue(move_groups[1], [0.25, 0.55])
    setJointValue(move_groups[1], [2.30, 0.55])
    #Right Arm
#    setJointValue(move_groups[4], [0.25, 0.55])
    setJointValue(move_groups[4], [2.30, 0.55])
    planning_groups = [
                        move_groups[0],
                        move_groups[1], move_groups[4]
                        ]
...
def allJointControl_6(move_groups):
    #Body
    setJointValue(move_groups[0], [-0.10, 0])
    #Left Arm
    setJointValue(move_groups[1], [0.00, 0.00])
    #Right Arm
    setJointValue(move_groups[4], [0.00, 0.00])
    planning_groups = [move_groups[0], 
                        move_groups[1], move_groups[4]]
...
#        display_trajectory_publisher = displayTrajectoryPublisher()
        ...
        if cmd_pose == '1':
            allJointControl_1(commanderLists)
        elif cmd_pose == '2':
            allJointControl_2(commanderLists)
        elif cmd_pose == '3':
            allJointControl_3(commanderLists)
        elif cmd_pose == '4':
            allJointControl_4(commanderLists)
        elif cmd_pose == '5':
            allJointControl_5(commanderLists)
        elif cmd_pose == '6':
            allJointControl_6(commanderLists)
        else:
            print "\nthere a 10 different poses 1 to 10."
            print "try any number 1, 2, 3, ..., or 10."
